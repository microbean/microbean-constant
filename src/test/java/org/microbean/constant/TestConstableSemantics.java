...
final class TestConstableSemantics {
  ...
  @Test
  final void testOptional() throws ReflectiveOperationException {
    final Optional<Integer> maybe3 = Optional.of(3);
    assertEquals(maybe3, Constables.describeConstable(maybe3).orElseThrow().resolveConstantDesc(MethodHandles.lookup()));
  }
